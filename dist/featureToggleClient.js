...
var FeatureToggleClient = /*#__PURE__*/function (_EventTarget) {
  ...
  function FeatureToggleClient(args) {
    var _this;
    _classCallCheck(this, FeatureToggleClient);
    _this = _super.call(this);
    _this.apiKey = args.apiKey;
    _this.refreshRate = parseTimeString(args.refreshRate);
    _this.refreshIntervalID;
    _this.payload;
    _this.updatePayload = _this.updatePayload.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(FeatureToggleClient, [{
    key: "start",
    value: function () {
      var _start = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _yield$fetchPayload, _yield$fetchPayload2, response, body;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetchPayload(null, this.apiKey);
            case 3:
              _yield$fetchPayload = _context.sent;
              _yield$fetchPayload2 = _slicedToArray(_yield$fetchPayload, 2);
              response = _yield$fetchPayload2[0];
              body = _yield$fetchPayload2[1];
              console.log(_typeof(response.status));
    ...
    key: "updatePayload",
    value: function () {
      var _updatePayload = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _yield$fetchPayload3, _yield$fetchPayload4, refreshPayload, body;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return fetchPayload(this.payload.last_updated, this.apiKey);
            case 3:
              _yield$fetchPayload3 = _context2.sent;
              _yield$fetchPayload4 = _slicedToArray(_yield$fetchPayload3, 2);
              refreshPayload = _yield$fetchPayload4[0];
              body = _yield$fetchPayload4[1];
      ...
      function updatePayload() {
        return _updatePayload.apply(this, arguments);
      }
